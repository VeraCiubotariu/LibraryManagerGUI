...
QT_MOC_LITERAL(1, 7, 11), // "listChanged"
QT_MOC_LITERAL(2, 19, 0) // ""

    },
    "BookUI\0listChanged\0"
};
...
void BookUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (BookUI::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BookUI::listChanged)) {
                *result = 0;
                return;
            }
        }
